...
namespace Eb.Dal
{
    class DataAccess
    {
        ...
        public static SqlDataReader executeReader(SqlParameter[] param, string storedProcedureName)
        {
        ...
        /// <param name="storedProcedureName"> Name of the stored procedure about to be executed. </param>
        /// <returns> Returns SqlDataReader with data from Select statement. </returns>
        public static SqlDataReader executeReader(string connString, SqlParameter[] param, string storedProcedureName)
        {
        ...
        /// <param name="storedProcedureName"> Name of the stored procedure about to be executed. </param>
        /// <returns> Returns SqlDataReader with data from Select statement. </returns>
        public static DataTable getDataTable(string connString, SqlParameter[] param, string storedProcedureName)
        {
        ...
        public static int updateTable(SqlParameter[] param, string storedProcedureName)
        {
        ...
        /// <param name="storedProcedureName"> Name of the stored procedure about to be executed. </param>
        /// <returns> Returns integer for error checking. </returns>
        public static int updateTable(string connString, SqlParameter[] param, string storedProcedureName)
        {
            int returnValue;
            SqlConnection connection = null;
            SqlCommand command = null;
        ...
        /// <param name="storedProcedureName"> Name of the stored procedure about to be executed. </param>
        /// <returns> Returns integer for error checking. </returns>
        public static int deleteRow(SqlParameter[] param, string storedProcedureName)
        {
        ...
        /// <param name="storedProcedureName"> Name of the stored procedure about to be executed. </param>
        /// <returns> Returns integer for error checking. </returns>
        public static int deleteRow(string connString, SqlParameter[] param, string storedProcedureName)
        {
            int returnValue;
            SqlConnection connection = null;
            SqlCommand command = null;
        ...
        public static int insertNewRecord(SqlParameter[] param, string storedProcedureName)
        {
        ...
        /// <param name="storedProcedureName"> Name of the stored procedure about to be executed. </param>
        /// <returns> Returns the primary key of the inserted value, if the called procedure returns that value.</returns>
        public static int insertNewRecord(string connString, SqlParameter[] param, string storedProcedureName)
        {
            int returnValue = 0;
            SqlConnection connection = null;
            SqlCommand command = null;
        ...
        public static object getSingleValue(SqlParameter[] param, string storedProcedureName)
        {
        ...
        /// <param name="storedProcedureName"> Name of the stored procedure about to be executed. </param>
        /// <returns> Returns the first row's first column value. </returns>
        public static object getSingleValue(string connString, SqlParameter[] param, string storedProcedureName)
        {
        ...
        public static void SetConnection(string connString, SqlParameter[] param, string storedProcedureName, out SqlConnection connection, out SqlCommand command)
        {
            var connStringFull = getConnectionString(connString);

            connection = new SqlConnection(connStringFull);
        ...
        /// </summary>
        /// <param name="connStringKey"> Shorthand connection string. </param>
        /// <returns></returns>
        private static string getConnectionString(string connStringKey)
        {
            string cStringKey;
            ...
            try
            {
                ...
                connStringKey = cStringKey != null ? cStringKey : connStringKey;
            }
            catch
            {
            ...
            var connectionStringEntry = ConfigurationManager.ConnectionStrings[connStringKey];
            ...
            {
                connectionString = ConfigurationManager.AppSettings[connStringKey];
            }

            if (connectionString == null)
            {
                throw new ApplicationException(string.Format("Could not find connection string in web.config for key '{0}'", connStringKey));
            }
